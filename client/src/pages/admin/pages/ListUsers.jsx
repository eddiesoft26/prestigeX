    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-1 font-medium font-mono">
            Monitor and manage your global investor base.
          </p>
        </div>
      ...
      <div className="grid gap-3">
        {filteredUsers.map((user) => (
          <div
            key={user.id}
            className="bg-[#1A1D21] border border-white/5 p-4 md:p-6 rounded-[2rem] hover:border-white/10 transition-all group"
          >
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="min-w-0">
                  <h4 className="text-white font-bold truncate tracking-tight">
                    {user.fullName}
                  </h4>
              ...
              <div className="grid grid-cols-2 lg:flex items-center gap-4 lg:gap-12">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-white mt-0.5">
                    $
                    {user?.totalAssets !== undefined
                      ? Number(user.totalAssets).toLocaleString(undefined, {
