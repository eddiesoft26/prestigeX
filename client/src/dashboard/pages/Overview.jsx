        ...
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter">
            ...
            <span className="text-slate-500">
              {summary?.user?.fullName?.split(" ")[0] || "Investor"}
            </span>
          </h1>
          <p className="mt-3 text-slate-400 font-medium flex items-center gap-2">
            ...
            Your accounts are secured with{" "}
            <span className="text-white font-bold">Quantum-AES Encryption</span>
          </p>
        </div>
        ...
        <div className="col-span-12 xl:col-span-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative group bg-gradient-to-br from-slate-900 to-[#020617] border border-white/5 rounded-[2.5rem] p-8 overflow-hidden">
              ...
              <p className="text-slate-400 text-sm mt-2 leading-relaxed max-w-[200px]">
                Diversify into prime physical assets. Current average APY:{" "}
                <span className="text-white font-bold">14.2%</span>
              </p>

              <button 
              onClick={ () => navigate('/dashboard/real-estate-portal')}
              className="mt-8 flex items-center gap-2 text-xs font-black text-white uppercase tracking-widest hover:gap-4 transition-all">
                Explore Deeds{" "}
                <HiOutlineArrowNarrowRight className="text-indigo-500" />
              </button>
            </div>
          ...
          <div className="bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-[3rem] p-10">
            <div className="flex justify-between items-center mb-8">
              ...
              <button className="text-[10px] font-black text-slate-500 hover:text-white transition-colors uppercase">
                View All
              </button>
            </div>
          ...
          <div className="sticky top-28">
            ...
            <div className="mt-8 p-8 rounded-[2.5rem] bg-indigo-600 shadow-2xl shadow-indigo-600/20 relative overflow-hidden">
              ...
              <h4 className="text-white font-black text-lg leading-tight">
                Invite your network. <br />
                Earn 10% lifetime.
              </h4>
              <button
                onClick={handleCopy}
                className="mt-6 w-full py-3 bg-white text-indigo-600 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 transition-colors cursor-pointer"
              >
